...
export default function ContractRequestPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = () => {
    ...
    router.push(`/consultations/${params.id}?company=${encodeURIComponent(companyName)}&contractSent=true`)
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center p-4 border-b">
        ...
        <div className="ml-2">
          ...
          <p className="text-sm text-gray-500">{companyName} · Air conditioner installation and cleaning</p>
        </div>
      </div>
